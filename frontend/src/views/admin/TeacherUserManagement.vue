<template>
  <div class="page-admin-list">
    <header class="page-head">
      <div class="page-head-row">
        <div>
          ...
          <p class="page-desc">教师账号增删改查；班级负责关系在「班级管理」中维护</p>
        </div>
    ...
    <el-card class="panel-card" shadow="never">
      ...
      <template v-else>
        <div class="panel-header inner">
          <div>
            <span class="panel-title">教师列表</span>
        ...
        <el-empty v-if="!rows.length" description="暂无教师数据" :image-size="100" />
    ...
    <el-dialog :title="editing ? '编辑教师' : '添加教师'" v-model="dialogVisible" destroy-on-close width="520px">
...
import { getTeacherUsers, updateUser, deleteUser as apiDeleteUser, createTeacher } from '../../api/user'
